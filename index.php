...
<body>
    ...
    <section class="header">
        <div class="headerLeft">
            ...
            <a class="btnHeader" href="pages/Katalog.html">Lihat Kelas</a>
        </div>
    ...
    <section class="Katalog">
        ...
        <div class="wrapperCard">
            ...
            <div class="Card">
                <div class="cardHeader">
                    <img src="assets/React.png" alt="Laravel" class="cardImg">
                </div>
                <div class="cardBody">
            ...
            <div class="Card">
                <div class="cardHeader">
                    <img src="assets/Vue.png" alt="Laravel" class="cardImg">
                </div>
                <div class="cardBody">
            ...
            <div class="Card">
                <div class="cardHeader">
                    <img src="assets/Adonis.png" alt="Laravel" class="cardImg">
                </div>
                <div class="cardBody">
